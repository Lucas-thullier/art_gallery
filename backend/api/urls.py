...
urlpatterns = format_suffix_patterns([
    ...
    path('painting/<int:pk>/', views.PaintingDetail.as_view(), name='painting-detail'),
    ...
    path('depiction/<int:pk>/', views.DepictionDetail.as_view(),  name='depiction-detail'),
    ...
    path('movement/<int:pk>/', views.MovementDetail.as_view(),  name='movement-detail'),
])
